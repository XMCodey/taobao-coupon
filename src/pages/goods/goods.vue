<template>
  ...
  <scroll-top-container style="height: calc(100vh - 108rpx); background-color: #f4f4f4" @scroll="scroll">
<!--    <view class="topMenuContainer"></view>-->
    <swiper class="swiper" indicator-dots="true">
      <swiper-item v-for="i in [,,,,]" class="swiper__item">
        <image mode="widthFix" class="swiper__image" src="https://img.alicdn.com/i2/3301007494/O1CN01x2q2QM25EIqXmOTZ5_!!3301007494.jpg_640x640.jpg"></image>
      </swiper-item>
    </swiper>
    <view class="container">
      ...
      <view class="couponInfoContainer">
        ...
        <view class="couponInfoContainer__des">
          <view>优惠券使用期限</view>2022.03.02-2022.03.15
        </view>
    ...
    <view class="shopContainer">
      <image class="shopImage" src="https://img.alicdn.com/bao/uploaded//e1/a9/TB1wXHZczMZ7e4jSZFOSut7epXa.jpg_310x310.jpg"></image>
    ...
    <view class="recommend-goods">
      <view class="recommend-goods-item" v-for="i in [,,,,,,,,,,,,]" key="i">
        <image mode="widthFix" src="https://img.alicdn.com/imgextra/i3/2206380846060/O1CN01PdqeH11udWtwD4ujD_!!2206380846060.jpg_310x310.jpg" class="recommend-goods-item__img"></image>
  ...
  <view class="bottomMenu"> <bb>  </bb>
    ...
    <view class="bottomMenu__getCoupon">
      ...
      <view class="bottomMenu__price">
        <view>
          ¥ 8.9
          <view class="bottomMenu__price__through">¥ 9.9</view>
        </view>
        领券购买
      </view>
    </view>
...
.bottomMenu {
  margin: 14rpx 20rpx 14rpx 40rpx;
  height: 80rpx;
  display: flex;
  align-items: center;
  justify-content: space-between;
